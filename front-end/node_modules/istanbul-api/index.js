 ...
 */
var Reporter = require('istanbul-api/lib/reporter');
/**
 * @module Exports
 */
module.exports = {
    config: require('istanbul-api/lib/config'),
    cover: require('istanbul-api/lib/run-cover'),
    reports: require('istanbul-api/lib/run-reports'),
    instrument: require('istanbul-api/lib/run-instrument'),
    checkCoverage: require('istanbul-api/lib/run-check-coverage'),
     ...
     */
    matcherFor: require('istanbul-api/lib/file-matcher').matcherFor,
    filesFor: require('istanbul-api/lib/file-matcher').filesFor
};
...
module.exports.reportsImpl = require('istanbul-api/node_modules/istanbul-reports');
